...
alter table PETCLINIC_VETERINARIAN_SPECIALTY_LINK add constraint FK_VETSPE_ON_VET foreign key (VET_ID) references PETCLINIC_VETERINARIAN(ID)^
alter table PETCLINIC_VETERINARIAN_SPECIALTY_LINK add constraint FK_VETSPE_ON_SPECIALTY foreign key (SPECIALTY_ID) references PETCLINIC_SPECIALTY(ID)^
